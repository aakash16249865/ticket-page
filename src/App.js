  ...
  <body className="">
      ...
      <div className=' lg:mx-0 mx-40'>
        ...
        <div className='px-14 py-10'>
          {/* <button class="text-[10px] border-2 px-4 py-2 rounded-full text-[#03e9f4] uppercase tracking-[4px] text-[16px] border-2 border-[#03e9f4] px-[22px] py-[7px] rounded-full hover:text-white hover:bg-[#03e9f4]" >EDIT DETAILS</button><br></br> */}
        </div>
      </div>
      </div>
    </body>
